^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package offshore_uav_pack
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Merged in xacro_for_oceanwaves (pull request #153)
  Modiying world definitions in offshore_uav_pack package to use xacro
...
* functional
* Install world_models in offshore_uav_pack
...
1.1.1 (2019-07-03)
------------------
* Missing ruby in build depend for offshore_uav_pack
